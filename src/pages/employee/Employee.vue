      ...
      <el-table :data="employee">
        ...
        <el-table-column label="操作" fixed="right">
          <template slot-scope="scope">
            <el-button type="text" @click="shenhe(scope.row)">审核</el-button>
          </template>
</el-table-column>
</el-table>
<!-- 表格结束 -->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                let url = "http://121.199.65.223:8888/user/auditing";
                get(url, {
                    id: this.emp.id
                }).then(response => {
                    this.$message({
            ...
            refuse() {
                let url = "http://121.199.65.223:8888/user/refuseAuditing";
                get(url, {
                    id: this.emp.id
                }).then(response => {
                    this.$message({
